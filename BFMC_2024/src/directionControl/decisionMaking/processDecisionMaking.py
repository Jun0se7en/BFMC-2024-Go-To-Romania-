...
class processDecisionMaking(WorkerProcess):
    ...
    def __init__(self, queueList, logging, Speed, Steer, debugging=False):
        ...
        self.flag_lane_keeping, self.flag_event_occured = Value('i', True), Value('i', False)
        self.Speed = Speed
        self.Steer = Steer
    ...
    def _init_threads(self):
        ...
        LaneKeepingTh = threadLaneKeeping(self.pipeRecv, self.pipeSend, self.queuesList, self.logging, self.Speed, self.Steer, self.debugging)
